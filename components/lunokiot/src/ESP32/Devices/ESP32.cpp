...
int ESP32Device::Restart(int argc, char **argv) {
    printf("\n\n ESP32Device *** RESTART NOW ***\n\n\n");
    fflush(stdout);
    esp_restart();
    return 0;
}
...
int ESP32Device::FreeMem(int argc, char **argv) {
...
int ESP32Device::Info(int argc, char **argv) {
...
int ESP32Device::LightSleep(int argc, char **argv) {
...
int ESP32Device::DeepSleep(int argc, char **argv) {
...
void ESP32Device::RegisterConsoleCommands(void) {
    const esp_console_cmd_t cmdRestart = {
        .command = "restart",
        .help = "Restart the device",
        .hint = NULL,
        .func = &ESP32Device::Restart,
        .argtable = nullptr
    };
